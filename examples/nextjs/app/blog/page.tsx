  ...
  return (
    <main style={{ maxWidth: 720, margin: '0 auto', padding: '2rem 1rem' }}>
      ...
      <article>
        ...
        <p style={{ marginTop: '0.5rem', color: '#666' }}>12 Mayıs 2025 · Blakfy Studio</p>

        <p style={{ marginTop: '1.5rem', lineHeight: 1.7 }}>
          Web erişilebilirliği, engelli kullanıcıların dijital içeriklere eşit biçimde
          erişebilmesini sağlar. WCAG 2.2 standartları; görme, işitme, motor ve bilişsel engelleri
          olan kullanıcılar için minimum gereksinimler tanımlar.
        </p>

        <h2 style={{ marginTop: '2rem' }}>Kontrast Oranları</h2>
        <p style={{ lineHeight: 1.7 }}>
          Normal metin için AA seviyesi en az <strong>4.5:1</strong> kontrast oranı gerektirir. AAA
          seviyesi için bu oran <strong>7:1</strong>'e çıkar. Widget'ın Yüksek Kontrast modunda
          sunduğu siyah zemin + sarı link kombinasyonu 7:1 oranını karşılar.
        </p>
        ...
        <p style={{ marginTop: '2rem', lineHeight: 1.7 }}>
          ...
          <a href="#">ARIA Authoring Practices</a>, <a href="#">WebAIM Kontrast Kontrolü</a>.
        </p>
      </article>
    </main>
  );
